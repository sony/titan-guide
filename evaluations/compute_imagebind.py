...
def get_batch_paths(chunk_generated_video_paths, ref_audio_root, text_ref):
    video_paths = []
    audio_paths= []
    text_list=  []
...
def imagebind_score(generated_video_root, ref_audio_root, prompts_path = "/mnt/data2/chris/code/Training-Free-Guidance/data/test_prompt_vgg.txt"):
    ...
    for i in range(len(generated_video_paths)//chunk_size):
        ...
        video_paths, audio_paths, text_list = get_batch_paths(chunk_generated_video_paths, ref_audio_root, text_ref)
        ...
        print(">>score mean: ", total_sum/count, total_sum_text/count, count)

    print("total su m: ", total_sum, count) ## ours: 640.1416, device='cuda:0') 2976
...
if __name__ == "__main__":
    ...
    generated_video_root = "/mnt/data2/chris/outputs/video_gen_guide/imagebind/cogvid/tfg_imagebind/" #"/mnt/data2/chris/outputs/video_gen_guide/imagebind/titan_vanilla_imagebind_100iters" ##  tensor(0.2209, device='cuda:0') tensor(0.3207, device='cuda:0')
    # generated_video_root = "/mnt/data2/chris/outputs/video_gen_guide/imagebind/titan_vanilla_imagebind_100iters" ##  tensor(0.2209, device='cuda:0') tensor(0.3207, device='cuda:0')
    # generated_video_root=  "/mnt/data2/chris/outputs/video_gen_guide/imagebind/titan256x256_gradest/" #"/mnt/data2/chris/outputs/vgg/test_ours" #"/mnt/data2/chris/outputs/vgg/test_seeinghearing/" ##  ##
    ref_audio_root = "/mnt/data2/dataset/vggsound/svg_no/audio2video/audio/"
    imagebind_score(generated_video_root, ref_audio_root)
