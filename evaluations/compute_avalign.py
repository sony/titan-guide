...
#### RESULT: V-Align:  0.4794728631017714 (ours), 0.4701 (Seeing&hearing), 
...
def detect_video_peaks(frames, fps):
    ...
    for i in range(1, len(frames)):#, desc="Process Frames"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--size", type=str, default="256:256", help="resize frames",)
    ...
    for file in tqdm.tqdm(files, desc="Process Videos"):
        ...
        try:
            ...
            score += tmp_score
            print(f'index:{index}, score:{tmp_score} , {score}, {index}')
            index+=1
        except:
            print("error")
