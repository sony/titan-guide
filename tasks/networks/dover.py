...
from .dover_conv_backbone import convnext_3d_small, convnext_3d_tiny, convnextv2_3d_pico, convnextv2_3d_femto
from .swin_backbone import SwinTransformer3D as VideoBackbone
from .dover_head import IQAHead, VARHead, VQAHead
    ...
    def forward(
        ...
        **kwargs
        ...
        if inference:
            ...
            self.train()
            # print(">> return_pooled_feats: ", return_pooled_feats, scores)
