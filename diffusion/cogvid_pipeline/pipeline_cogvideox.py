...
# from diffusers.video_processor import VideoProcessor
# import gc
# from .transformer3d import CogVideoXTransformer3DModel
...
#         # print(">>> self.transformer: ", self.transformer.config.in_channels, self.vae.config.latent_channels) 33 16
#         sample_size = (height, width)
#         input_video, input_video_mask, _ = get_image_to_video_latent(None, None, video_length=num_frames, sample_size=sample_size)
...
#         # 7. Create rotary embeds if required
#         # print(">>> self.transformer.config.use_rotary_positional_embeddings: ", self.transformer.config.use_rotary_positional_embeddings)
#         image_rotary_emb = (
#             self._prepare_rotary_positional_embeddings(height, width, latents.size(1), device)
#             if self.transformer.config.use_rotary_positional_embeddings
#             else None
...
#         print(">>> transformer.config.in_channels != vae.config.latent_channels: ", self.transformer.config.in_channels, self.vae.config.latent_channels)
