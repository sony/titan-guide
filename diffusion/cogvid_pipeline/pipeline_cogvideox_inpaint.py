...
class CogVideoX_Fun_Pipeline_Inpaint(DiffusionPipeline):
    ...
    def _get_t5_prompt_embeds(
        ...
        # print(">> self. text_encoder: ", self.text_encoder.device, text_input_ids.device)
    ...
    def __call__(
        ...
        # print(">>latents_outputs: ", latents_outputs[0].shape, latents_outputs[1].shape) ## torch.Size([1, 6, 16, 32, 32]) torch.Size([1, 6, 16, 32, 32])
