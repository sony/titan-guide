...
class StableDiffusionVideoCogVidSampler(BaseSampler):
    ...
    def _build_diffusion(self, args):
        ...
        unet = self.sd_pipeline.transformer
        unet.eval()
        ...
        self.height = self.height //4 *3 #//2 #//4 *3
        self.width = self.width //4 *3 #//2 #//4 *3
    ...
    def tensor_to_obj(self, x):
        ...
        export_to_video(videos[0], f"logs/ims_fwdvideo/animation_dograin_temporal_.mp4", fps=4)
