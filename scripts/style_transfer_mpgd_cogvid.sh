...
model_name_or_path='emilianJR/epiCRealism' ## not used for CogVid model
...
# target_text='dog is barking under fire'
target='data/wikiart/0.png' 
recur_steps=1
rho_schedule="decrease"
save_path="outputs/style_transfer/mpgd_cogvid/" 
...
guidance_name='mpgd_video'
eval_batch_size=1
wandb=False
guidance_strength=1.0 #20 
# rho=0.25
rho=.5
mu=2 #2
sigma=0.1
