...
image_size=512
dataset="data/test_prompt_vgg_0.txt"
model_name_or_path='emilianJR/epiCRealism'
task=video_inpainting_nograd
guide_network='openai/clip-vit-base-patch16'
target='./datasets/vggsound/reference_videos_2secs/' ## change this to your folder for target videos
recur_steps=1
rho_schedule="decrease"
save_path="./outputs/video_gen_guide/video_inpaint/titan_scorebased/"


train_steps=1000
inference_steps=25 #15 #15
eta=1.0
clip_x0=False
seed=42
logging_dir='logs'
